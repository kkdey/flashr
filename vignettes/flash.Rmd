...
svdf = svd(Y)$v
svdd = svd(Y)$d
plot(svdd, type = "h", ylim = c(0, max(svdd)), xlab = "Singular Value", ylab = "Value",
     main = "Scree Plot of the Singular Values")
svdK = 10
...
## backfitting is broken
##gback = backfitting(Y,gl,gf, maxiter_r1 = 10)
##gbl = gback$l
##gbf = gback$f
##dim(gbl)
